    ...
    <nav className="bg-heading my-4 mx-4 rounded-lg shadow-md md:w-2xl md:mx-auto lg:w-4xl xl:w-5xl 2xl:w-7xl p-2 sticky top-5">
      <div className="mx-auto px-2 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            <path
              d="M5045 9424 c-361 -33 -530 -64 -784 -146 -128 -41 -319 -118 -358
...
-3 29 100 52 173 39 370 126 495 219 29 22 44 23 129 1z"
            />
            <path
              d="M6009 8096 c-60 -21 -96 -54 -124 -111 -63 -129 -30 -325 55 -325 50
0 60 21 60 126 0 113 19 160 77 195 47 28 63 47 63 75 0 47 -60 65 -131 40z"
            />
            <path
              d="M4632 7994 c-16 -11 -22 -24 -20 -42 2 -23 16 -34 83 -67 100 -50
125 -90 125 -196 0 -81 5 -98 37 -110 36 -14 79 12 94 58 34 102 1 231 -76
302 -68 62 -193 91 -243 55z"
            />
            <path
              d="M3888 5259 c-10 -5 -18 -16 -18 -23 0 -25 38 -46 263 -140 372 -157
