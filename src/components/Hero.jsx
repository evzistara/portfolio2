...
export default function Hero() {
  ...
  return (
    <section id="" className="py-32 px-10 md:py-40 md:px-24">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-foreground mb-6 text-balance">Hey, I am Evzi!</h1>
        <p className="text-lg md:text-xl text-muted-foreground mb-8 leading-relaxed text-pretty">
        I am a an ex-marketer with experience with SEO and SEM, but I found my new passion in programming and also combining my knowledge. I am a front-end developer, but I am also <span className="">{facts[index]}</span></p>
