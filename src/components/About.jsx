  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 md:flex-row md:gap-10 lg:w-5xl lg:mx-auto">
      ...
      <div>
        ...
        <p className="mb-4">
          I'm currently studying a<span className="font-bold text-primary"> year-long IT program at OsloMet</span> . And on the side I’m
        ...
        <p className="mb-4">
          ...
          Specialist</span> in various marketing agencies. I love findining solutions to problems and make things better.
        </p>
        <p>
